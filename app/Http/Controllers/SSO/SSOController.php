...
class SSOController extends Controller
{
    public function getLogin(Request $request)
    {
        ...
        $query = http_build_query([
            'client_id' => '968a5879-d02f-4026-a76e-894dd51f68b2',
    ...
    public function getCallback(Request $request)
    {
        ...
        $response = Http::asForm()->post('http://20.227.138.204/oauth/token', [
            ...
            'client_id' => '968a5879-d02f-4026-a76e-894dd51f68b2',
            'client_secret' => '95h1iPwicStpwUw1MV7ngmnOsvjSE4Jyksewn2hu',
            'redirect_uri' => 'http://127.0.0.1:8080/callback',
            'code' => $request->code,
        ]);
...
//             $user->email_verified_at = $userArray['data']['user']['email_verified_at'];
//             $user->save();
//         }
//         Auth::login($user);
